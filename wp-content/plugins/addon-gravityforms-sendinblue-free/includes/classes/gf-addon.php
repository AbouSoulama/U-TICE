...
class GF_Addon extends GFFeedAddOn {
	...
	/**
	 * Output the custom license field/button section.
	 *
	 * @return void
	 */
	public function settings_wpc_license_field() {
		echo '<div class="license-key-container">';

		$this->settings_text(
			array(
				'name'     => 'wpc-sib-license',
				'value'    => '',
				'label'    => esc_html__( 'License Key', 'addon-gravityforms-sendinblue-free' ),
				'disabled' => true,
			)
		);
		/*
		printf(
			'<a target="_blank" href="%1$s" class="primary button large activate">%2$s</a>',
			'https://wpconnect.co/gravity-forms-sendinblue-add-on/',
			esc_html__( 'Upgrade to Pro version', 'addon-gravityforms-sendinblue-free' )
		);*/
