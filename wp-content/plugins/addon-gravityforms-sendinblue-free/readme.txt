...
= 2.1.0 =
* Added: "emailBlacklisted" parameter when creating a contact
* Fixed error api not showing in metaboxe of entries Gravity Forms
* WordPress 6.4.0 compatibility

= 2.0.0 = 
* Changed : Brevo (ex Sendinblue) name to Brevo
* WordPress 6.3 compatibility

= 1.1.0 = 
* Added: Switch between the free version and the pro version
* Changed : Sendinblue name to Brevo

= 1.0.3 =
* WordPress 6.2 compatibility

= 1.0.2 =
* Added: Upgrade to Pro link

= 1.0.1 =
* Fixed: Test to verify if Pro version is activated
* Fixed: JavaScripts errors on other Gravity Forms add-ons
