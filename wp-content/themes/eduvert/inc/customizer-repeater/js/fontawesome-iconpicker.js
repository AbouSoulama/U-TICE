(function ($) {
    ...
    wp.eduvertcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                eduvert_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.eduvertcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.eduvertcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.eduvertcustomizerRepeater.iconPickerToggle($(this));
        });
