 ...
 */
function eduvert_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function eduvert_sanitize_html( $html ) {
 ...
 */
function eduvert_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function eduvert_sanitize_range_value( $number, $setting ) {
 ...
 */
function eduvert_sanitize_select( $input, $setting ) {
 ...
 */
function eduvert_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function eduvert_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function eduvert_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}