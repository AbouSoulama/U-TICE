...
function soccer_academy_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('soccer_academy_read_more_icon',array(
		'default'	=> 'fas fa-arrow-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Soccer_Academy_Fontawesome_Icon_Chooser(
        $wp_customize,'soccer_academy_read_more_icon',array(
		'label'	=> __('Read More Icon','soccer-academy'),
		'transport' => 'refresh',
		'section'	=> 'soccer_academy_archieve_post_layot',
		'setting'	=> 'soccer_academy_read_more_icon',
		'type'		=> 'icon'
	)));
	...
	if ( class_exists( 'WooCommerce' ) ) { 
		$wp_customize->add_section('soccer_academy_woocoomerce_settings',array(
	        'title' => __('WooCommerce Settings', 'soccer-academy'),
	        'priority' => 4
	    ) );
	...
	//button
	$wp_customize->add_section('soccer_academy_button_options',array(
        'title' => __('Button settings', 'soccer-academy'),
        'priority' => 4,
    ) );
    $wp_customize->add_setting( 'soccer_academy_section_button_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Soccer_Academy_Customizer_Customcontrol_Section_Heading( $wp_customize, 'soccer_academy_section_button_heading', array(
		'label'       => esc_html__( 'Theme Button Settings', 'soccer-academy' ),
		'section'     => 'soccer_academy_button_options',
		'settings'    => 'soccer_academy_section_button_heading',
	) ) );
    $wp_customize->add_setting( 'soccer_academy_theme_button_color', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'soccer_academy_theme_button_color', array(
	    'label' => __('Background Color','soccer-academy'),
	    'section' => 'soccer_academy_button_options',
	    'settings' => 'soccer_academy_theme_button_color',
  	)));
	$wp_customize->add_setting('soccer_academy_button_border_radius',array(
		'default'=> 0,
		'transport' => 'refresh',
		'sanitize_callback' => 'soccer_academy_sanitize_integer'
	));
	$wp_customize->add_control(new Soccer_Academy_Slider_Custom_Control( $wp_customize, 'soccer_academy_button_border_radius',array(
		'label' => esc_html__( 'Border Radius','soccer-academy' ),
		'section'=> 'soccer_academy_button_options',
		'settings'=>'soccer_academy_button_border_radius',
		'input_attrs' => array(
			'reset'			   => 0,
            'step'             => 1,
			'min'              => 0,
...
define('SOCCER_ACADEMY_PRO_LINK',__('https://www.ovationthemes.com/wordpress/soccer-club-wordpress-theme/','soccer-academy'));
