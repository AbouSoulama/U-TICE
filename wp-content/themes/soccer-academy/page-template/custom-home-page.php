...
<main id="content">
  <?php if( get_option('soccer_academy_slider_arrows') == '1'){ ?>
    <section id="slider">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div <?php if($slides == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              ...
              <div class="home-btn my-lg-4 my-md-4 mb-3">
                <a class="p-lg-3 p-md-2 p-1" href="<?php the_permalink(); ?>"><?php echo esc_html('Read More','soccer-academy'); ?></a>
              </div>
            </div>
          </div>
          <?php $slides++; endwhile;
        ...
        <div class="social-icon">
          <?php if( get_theme_mod('soccer_academy_twitter') != ''){ ?>
            <a target="<?php echo $soccer_academy_header_twt_target !='off' ? '_blank' : '' ?>" href="<?php echo esc_url(get_theme_mod('soccer_academy_twitter','')); ?>">
              <i class="<?php echo esc_attr(get_theme_mod('soccer_academy_twitter_icon','fab fa-twitter')); ?>"></i>
            </a>
          <?php }?>
  ...
  <?php }?>
   <?php if( get_option('soccer_academy_player_show_hide') == '1'){ ?>
  <section id="player">
    <div class="container py-5">
      <?php if( get_theme_mod('soccer_academy_player_sub_heading') != ''){ ?>
        <h4 class="text-lg-left text-center"><?php echo esc_html(get_theme_mod('soccer_academy_player_sub_heading','')); ?></h4>
      <?php }?>
      <?php if( get_theme_mod('soccer_academy_player_heading') != ''){ ?>
        <h3 class="text-lg-left text-center"><?php echo esc_html(get_theme_mod('soccer_academy_player_heading','')); ?></h3>
      <?php }?>
      <div class="owl-carousel mt-5">
        <?php
          ...
          <div class="row">
            ...
            <div class="player-content col-lg-7 pl-lg-5">
              <?php if( get_theme_mod('soccer_academy_player_1'.$i) != ''){ ?>
                <h3 class="text-lg-left text-center mt-1"><?php echo esc_html(get_theme_mod('soccer_academy_player_1'.$i)); ?></h3>
              <?php }?>
              <div class="row">
                <div  class="col-lg-10 col-6 text-lg-left text-center align-self-center">
                  <?php if( get_theme_mod('soccer_academy_team_name'.$i) != ''){ ?>
                    <p class="mb-0 py-lg-1 pl-2 team-name"><?php echo esc_html(get_theme_mod('soccer_academy_team_name'.$i)); ?></p>
                  <?php }?>
                </div>
                <div class="col-lg-2 col-6 text-lg-right text-center align-self-center">
              ...
              <div class="player-details mt-4 py-2">
                <div class="row">
                  <div class="player-age pl-lg-5 pr-lg-3 px-5 text-center col-lg-4 col-md-4  align-self-center">
                    <?php if( get_theme_mod('soccer_academy_player_b'.$i) != ''){ ?>
                      <p class="mb-0 mt-3 p-2 text-lg-left text-md-left text-center"><?php esc_html_e('Born:','soccer-academy'); ?><?php echo esc_html(get_theme_mod('soccer_academy_player_b'.$i)); ?></p>
                    <?php }?>
                    <?php if( get_theme_mod('soccer_academy_player_a'.$i) != ''){ ?>
                      <p class="mb-0 mt-2 p-2 text-lg-left text-md-left text-center"><?php esc_html_e('Age: ','soccer-academy'); ?><?php echo esc_html(get_theme_mod('soccer_academy_player_a'.$i)); ?></p>
                    <?php }?>
                    <?php if( get_theme_mod('soccer_academy_player_c'.$i) != ''){ ?>
                      <p class="mb-3 mt-2 p-2 text-lg-left text-md-left text-center"><?php esc_html_e('Country: ','soccer-academy'); ?><?php echo esc_html(get_theme_mod('soccer_academy_player_c'.$i)); ?></p>
                    <?php }?>
                  </div >
                  <div class="col-lg-8 col-md-8 align-self-center">
                    <div class="row">
                      <div class=" height col-lg-5 col-md-5  col-5 mx-lg-2 mx-md-2  ml-4 py-4 text-center">
